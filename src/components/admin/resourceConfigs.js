...
export const resourceConfigs = {
  ...
  [ENTITY_TYPES.PROJECT]: {
    ...
    fields: [
      ...
      },
      {
        ...
        control: CONTROL_TYPES.ASSET_GROUP,
        fields: [
          assetField("surroundingsZoomoutVideoId", "Zoom-out", [
            AssetType.VIDEO,
          ]),
          assetField("surroundingsForwardVideoId", "Forward", [
            AssetType.VIDEO,
          ]),
          assetField("surroundingsReverseVideoId", "Reverse", [
            AssetType.VIDEO,
          ]),
  ...
  [ENTITY_TYPES.UNIT_TYPE]: {
    ...
    fields: [
      ...
      },
      {
        ...
        label:
          "Service rooms (comma-separated, e.g. Maid's Room, Hard Kitchen)",
        control: CONTROL_TYPES.TEXT,
        required: false,
        disabled: false,
      },
  ...
  [ENTITY_TYPES.UNIT]: {
    ...
    fields: [
      ...
      assetField("balconyAssetId", "Balcony", [
        AssetType.IMAGE,
        AssetType.VIDEO,
        AssetType.PANORAMA,
      ]),
