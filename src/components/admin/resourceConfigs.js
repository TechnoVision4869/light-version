...
export const resourceConfigs = {
  ...
  [ENTITY_TYPES.PROJECT]: {
    ...
    schema: yup.object().shape({
      ...
      zonesZoomoutVideoId: yup.string().nullable(),
      zonesForwardVideoId: yup.string().nullable(),
      zonesReverseVideoId: yup.string().nullable(),
      zonesSideVideoId: yup.string().nullable(),
      surroundingsZoomoutVideoId: yup.string().nullable(),
      surroundingsForwardVideoId: yup.string().nullable(),
      surroundingsReverseVideoId: yup.string().nullable(),
      surroundingsSideVideoId: yup.string().nullable(),
      amenitiesZoomoutVideoId: yup.string().nullable(),
      amenitiesForwardVideoId: yup.string().nullable(),
      amenitiesReverseVideoId: yup.string().nullable(),
      amenitiesSideVideoId: yup.string().nullable(),
      zonesMetadata: yup.mixed().nullable(),
    }),
    fields: [
      nameField(),
      idField("developerId", "Developer ID"),
      assetField("thumbnailAssetId", "Thumbnail", [AssetType.IMAGE, AssetType.THUMBNAIL]),
      {
        name: "description",
        label: "Description",
      ...
      },
      {
        ...
        control: CONTROL_TYPES.ASSET_GROUP,
        fields: [
      ...
      },
      {
        ...
        control: CONTROL_TYPES.ASSET_GROUP,
        fields: [
          assetField("zonesZoomoutVideoId", "Zoom-out", [AssetType.VIDEO]),
          assetField("zonesForwardVideoId", "Forward", [AssetType.VIDEO]),
          assetField("zonesReverseVideoId", "Reverse", [AssetType.VIDEO]),
          assetField("zonesSideVideoId", "Side", [AssetType.VIDEO]),
        ],
      },
      {
        name: "surroundingsVideos",
        label: "Surroundings Videos",
        control: CONTROL_TYPES.ASSET_GROUP,
        fields: [
          assetField("surroundingsZoomoutVideoId", "Zoom-out", [AssetType.VIDEO]),
          assetField("surroundingsForwardVideoId", "Forward", [AssetType.VIDEO]),
          assetField("surroundingsReverseVideoId", "Reverse", [AssetType.VIDEO]),
          assetField("surroundingsSideVideoId", "Side", [AssetType.VIDEO]),
        ],
      },
      {
        name: "amenitiesVideos",
        label: "Amenities Videos",
        control: CONTROL_TYPES.ASSET_GROUP,
        fields: [
          assetField("amenitiesZoomoutVideoId", "Zoom-out", [AssetType.VIDEO]),
          assetField("amenitiesForwardVideoId", "Forward", [AssetType.VIDEO]),
          assetField("amenitiesReverseVideoId", "Reverse", [AssetType.VIDEO]),
          assetField("amenitiesSideVideoId", "Side", [AssetType.VIDEO]),
        ],
      },
      {
        name: "zonesMetadata",
        label: "Zones Metadata Videos",
        control: CONTROL_TYPES.ASSET_GROUP,
        fields: [
          assetField("zonesMetadata.videos.forwardVideoId", "Forward Video ID", [AssetType.VIDEO]),
          assetField("zonesMetadata.videos.reverseVideoId", "Reverse Video ID", [AssetType.VIDEO]),
          assetField("zonesMetadata.videos.sideVideoId", "Side Video ID", [AssetType.VIDEO]),
        ],
      },
    ],
  ...
  [ENTITY_TYPES.UNIT_TYPE]: {
    ...
    schema: yup.object().shape({
      ...
      serviceRoomNames: yup.mixed(),
      area: yup.number().nullable(),
      gallery: yup.array().nullable(),
      cutSections: yup.array().nullable(),
      floorPlans: yup.array().nullable(),
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Service rooms (comma-separated, e.g. Maid's Room, Hard Kitchen)",
        control: CONTROL_TYPES.TEXT,
        required: false,
        disabled: false,
      },
      {
        name: "gallery",
        label: "Gallery",
        control: CONTROL_TYPES.ASSET_ARRAY,
        required: false,
        disabled: false,
        allowedTypes: [AssetType.IMAGE, AssetType.VIDEO, AssetType.THUMBNAIL, AssetType.PANORAMA],
      },
      {
        name: "cutSections",
        label: "Cut sections",
      ...
      },
      {
        name: "paymentPlans",
        label: "Payment plans",
        control: CONTROL_TYPES.PAYMENT_PLANS_ARRAY,
        required: false,
        disabled: false,
      },
      {
        name: "levels",
        label: "Levels",
        control: CONTROL_TYPES.LEVELS_ARRAY,
        required: false,
        disabled: false,
      },
    ],
